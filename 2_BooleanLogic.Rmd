...
#### Exercise: Count the number of oceans with an average depth > 4000m

Using the data.frame that we built in an earlier class, we can subset the oceans with a depth > 4000m. 
