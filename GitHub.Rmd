...
Note: If you want to commit all of your files at once and you don't want to go through and check (or uncheck) each box next to every single file, highlight one file in the Git pane and press `CNTRL+A` on your keyboard. This will select all files at once. If you check one of the boxes now, the boxes next to all selected files will be checked. 
